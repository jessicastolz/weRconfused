...
```
PGLS model of hind-limb variation under BM character evolution and with Ecomorph as a covariate yielded the best fit (BM2). Model fit was visualized for each Ecomorph in the following graph. 
