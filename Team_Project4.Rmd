...
```
### The results revealed a positive correlation between the ecomorphs and the hindlimb-SVL relationship in anoles. This is shwon through the use of AIC, BM and OU models. 
...
## Discussion 
### The results from the experiment indicate a relationship between the hindlimb-SVL length and the ecomorphs. Through the use of Brownian and OU models, the data indicates that species with similar ecological niches, but not necessarily a common ancestor, have similar phylogenetic expression despite due to their common niche. 
